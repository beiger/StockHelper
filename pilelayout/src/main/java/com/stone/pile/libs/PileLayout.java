...
public class PileLayout extends ViewGroup {
    ...
    public PileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PileLayout);
        interval = (int) a.getDimension(R.styleable.PileLayout_interval, interval);
        sizeRatio = a.getFloat(R.styleable.PileLayout_sizeRatio, sizeRatio);
        scaleStep = a.getFloat(R.styleable.PileLayout_scaleStep, scaleStep);
        displayCount = a.getFloat(R.styleable.PileLayout_displayCount, displayCount);
        a.recycle();
