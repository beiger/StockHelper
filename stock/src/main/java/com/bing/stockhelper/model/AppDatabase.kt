...
abstract class AppDatabase : RoomDatabase() {
        ...
        fun insertStocks(items: List<StockDetail>) = stockDetailDao().insert(items)
        ...
        fun insertOrders(items: List<OrderDetail>) = orderDetailDao().insert(items)
        ...
        fun insertFollows(items: List<ItemFollow>) = itemFollowDao().insert(items)
        ...
        fun insertSummarys(items: List<Summary>) = summaryDao().insert(items)
        ...
        fun insertStockTags(items: List<StockTag>) = stockTagDao().insert(items)
        ...
        fun insertDayAttentions(items: List<DayAttention>) = dayAttentionDao().insert(items)
        ...
        fun insertConcernedTags(items: List<ConcernedTag>) = concernedTagDao().insert(items)
        ...
        fun insertCollectArticles(items: List<CollectArticle>) = collectArticleDao().insert(items)
